...
<div class="card" style="margin-bottom:1.25rem">
  ...
  <form method="POST" action="{{ route('dashboard.media.store') }}" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      @error('files.*')<div class="field-error">{{ $message }}</div>@enderror
      <div class="f-hint">Select multiple — JPG, PNG, WEBP, GIF — max 50 MB per file, 60 MB total. Once uploaded, pick them from the library anywhere — on a Project or a Design.</div>
    </div>
